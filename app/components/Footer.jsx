...
const Footer = () => {
  ...
  const quickLinks = [
    { label: "Classificação", href: "/Liga/Classification" },
    { label: "Calendário", href: "/Liga/Calendar" },
    { label: "Melhores Marcadores", href: "/Liga/TopScorers" },
    { label: "Disciplina", href: "/Liga/Discipline" },
  ];

  const competitions = [
    { label: "Liga Veteranos", href: "/Liga/Classification" },
    { label: "Taça", href: "/Taca/Draw" },
